...
Version actual: 1.2.9. Los archivos `.mcaddon` se exportan con version en el nombre y los packs muestran la version en Minecraft.
...
- Animacion: usa el controlador vanilla-style `controller.animation.shield.wield` con fallback propio.
...
1. Importa `Addon_Items_3D_v1.2.9.mcaddon`.
2. Activa `Items 3D BP v1.2.9` y `Items 3D RP v1.2.9`.
