...
Version actual: 1.0.8. Los archivos `.mcaddon` se exportan con version en el nombre y los packs muestran la version en Minecraft.
...
1. Importa `Addon_Items_3D_v1.0.8.mcaddon`.
2. Activa `Items 3D BP v1.0.8` y `Items 3D RP v1.0.8`.
